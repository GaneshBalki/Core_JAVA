...
public class Convertor2 extends HttpServlet{
	float num1,num2,rate;
	
	
	@Override
		public void init(ServletConfig config) throws ServletException {
			super.init(config);
			this.rate= Float.parseFloat(config.getInitParameter("rate"));
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException {
    	...
    	out.println("<!DOCTYPE html>\r\n"
    			...
    			+ "</head>\r\n"
    			+ "<body>\r\n<center>"
    			+ "	<form action=\"convertor2\" method=\"get\" style=\"margin-top: 100px;margin-bottom: 20px;\">\r\n"
    			+ "		<table>\r\n"
    			+ "		\r\n"
    			+ "				<tr>\r\n"
